 ...
 * 
 */
@WebServiceClient(name = "MovieServiceImplService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:8069/rating?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8069/rating?wsdl");
